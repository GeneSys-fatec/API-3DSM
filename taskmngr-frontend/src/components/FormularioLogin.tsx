            ...
            <div className="flex flex-col md:flex-row justify-center bg-gray-100 items-center min-h-screen p-4">
                    ...
                    <form className="w-full flex flex-col items-center gap-6 md:gap-4" onSubmit={this.handleSubmit}>
                        <div className="relative w-full max-w-xs">
                            <div className="relative">
                                ...
                                <input type="email" placeholder="E-mail" name="email" className="w-full bg-white pl-10 pr-3 py-2 border border-gray-300 outline-none rounded-sm" value={email} onChange={this.handleChange} required />
                            </div>
                        ...
                        <div className="relative w-full max-w-xs">
                            <div className="relative">
                                ...
                                <input type="password" placeholder="Senha" name="senha" className="w-full bg-white pl-10 pr-3 py-2 border border-gray-300 outline-none rounded-sm" value={senha} onChange={this.handleChange} required />
                            </div>
                ...
                <div className="hidden md:flex w-full md:w-120 h-auto md:h-120 flex-col items-center justify-center bg-indigo-950 shadow-md rounded-e-sm p-6">
                    ...
                    <p className="text-center text-white text-sm md:text-base">
                        Para se manter conectado com a gente,<br />por favor digite suas informações pessoais.
                    </p>
...
export default withNavigation(FormularioLogin);
