...
export default class FormularioLogin extends React.Component<LoginProps, LoginState> {
                ...
                <div className="w-full md:w-120 h-auto md:h-120 flex flex-col items-center justify-center md:bg-gray-200 md:shadow-md md:rounded-s-sm p-6 z-0">
                    ...
                    <form className="w-full flex flex-col items-center gap-6 md:gap-4" onSubmit={this.handleSubmit}>
                        <div className="relative w-full max-w-xs">
                            ...
                            <input type="email" placeholder="E-mail" name="email" className="w-full bg-white pl-10 pr-3 py-2 border border-gray-300 outline-none rounded-sm" value={this.state.email} onChange={this.handleChange} required></input>
                        </div>
                        <div className="relative w-full max-w-xs">
                            <i className="fa-solid fa-lock absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                            <input type="password" placeholder="Senha" name="senha" className="w-full bg-white pl-10 pr-3 py-2 border border-gray-300 outline-none rounded-sm" value={this.state.senha} onChange={this.handleChange} required></input>
                        </div>
                    ...
                    <Link to="/cadastro" className="underline decoration-solid p-2 text-sm hover:text-blue-900">Não tem uma conta? Cadastre-se</Link>
                </div>
